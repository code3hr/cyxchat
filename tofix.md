...
- [x] CI/CD release workflow: GitHub Actions now validates Flutter, builds Windows/macOS/Android release artifacts, uploads per-platform artifacts on main/manual runs, and publishes all artifacts to a GitHub Release on `v*` tags.
